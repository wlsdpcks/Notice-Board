                            ...
                            <div className = "card-body">
                                <form>
                                    <div className = "form-group">
                                        ...
                                        value={this.state.type} onChange={this.changeHandler}>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        value={this.state.contents} onChange={this.changeHandler}/>
                                    </div>
                                    <div className = "form-group">
                                        <label> MemberNo  </label>
                                        <input placeholder="memberNo" name="memberNo" className="form-control" 
                                        value={this.state.memberNo} onChange={this.changeHandler}/>
                                    </div>
